...
$lang = array_merge($lang, array(
	...
	'AM'					=> 'AM',
	'PM_TIME'				=> 'Асабістае паведамленне',
...
$lang = array_merge($lang, array(
	...
	'NO_POST_EVENT_MODE'		=> 'Не паказаны рэжым паведамлення.',
	'PM'						=> 'Асабістае паведамленне',
...
$lang = array_merge($lang, array(
	'RECAPTCHA_LANG'				=> 'be',
	'RECAPTCHA_NOT_AVAILABLE'		=> 'Для выкарыстання reCaptcha неабходна стварыць уліковы запіс на бачыне <a href="http://www.google.com/recaptcha">www.google.com/recaptcha</a>.',
	'CAPTCHA_RECAPTCHA'				=> 'reCaptcha',
	'RECAPTCHA_INCORRECT'			=> 'Няслушны код візуальнага пацверджання',

	'RECAPTCHA_PUBLIC'				=> 'Публічны ключ reCaptcha (Public Key)',
	'RECAPTCHA_PUBLIC_EXPLAIN'		=> 'Ваш публічны ключ reCaptcha. Ключы можна атрымаць на бачыне <a href="http://www.google.com/recaptcha">www.google.com/recaptcha</a>.',
	'RECAPTCHA_PRIVATE'				=> 'Зачынены ключ reCaptcha (Private Key)',
	'RECAPTCHA_PRIVATE_EXPLAIN'		=> 'Ваш зачынены ключ reCaptcha. Ключы можна атрымаць на бачыне <a href="http://www.google.com/recaptcha">www.google.com/recaptcha</a>.',
...
$lang = array_merge($lang, array(
	...
	'AVATAR_NO_SIZE'				=> 'Не атрымалася вызначыць памеры паказанай аватары. Увядзіце іх уручную.',
	...
	'BOARD_DISABLE'			=> 'Выбачайце, але канферэнцыя ў сапраўдны момант недаступная',
	...
	'FORUM'					=> 'Форум',
	'FORUMS'				=> 'Форумы',
	'FORUMS_MARKED'			=> 'Вылучаныя форумы адзначаныя як прачытаныя',
	'FORUM_CAT'				=> 'Катэгорыя',
	...
	'FSOCK_TIMEOUT'			=> 'Таймаўт злучэння.',
	...
	'IN'						=> 'у форуме',
	'INDEX'						=> 'Галоўная старонка', //Index page
	...
	'MARK_SUBFORUMS_READ'	=> 'Адзначыць падфорумы як прачытаныя',
	'MB'					=> 'MБ',
	'MIB'					=> 'MіБ',
	...
	'NEW_POST'					=> 'Новае паведамленне',	// Not used anymore
	'NEW_POSTS'					=> 'Новыя паведамленні',	// Not used anymore
	...
	'NO_NEW_POSTS'				=> 'Няма новых паведамленняў',	// Not used anymore
	...
	'POWERED_BY'			=> 'Створана на аснове %s',
	'PREVIEW'				=> 'Прадпрагляд',
	...
	'SEND_EMAIL'				=> 'Адправіць email',				// Used for submit buttons
	...
	'UNWATCH_FORUM_CONFIRM'		=> 'Вы сапраўды жадаеце адпісацца ад дадзенага форуму?',
	'UNWATCH_FORUM_DETAILED'	=> 'Вы сапраўды жадаеце адпісацца ад форума «%s»?',
	'UNWATCH_TOPIC_CONFIRM'		=> 'Вы сапраўды жадаеце адпісацца ад гэтай тэмы?',
	'UNWATCH_TOPIC_DETAILED'	=> 'Вы сапраўды жадаеце адпісацца ад тэмы «%s»?',
	...
	'WATCH_FORUM_CONFIRM'	=> 'Вы сапраўды жадаеце падпісацца на дадзены форум?',
	'WATCH_FORUM_DETAILED'	=> 'Вы сапраўды жадаеце падпісацца на форум «%s»?',
	'WATCH_TOPIC_CONFIRM'	=> 'Вы сапраўды жадаеце падпісацца на дадзеную тэму?',
	'WATCH_TOPIC_DETAILED'	=> 'Вы сапраўды жадаеце падпісацца на тэму «%s»?',
...
$lang = array_merge($lang, array(
	...
	'DB_HOST_EXPLAIN'			=> 'DSN - імя крыніцы дадзеных пры ўсталёўцы з выкарыстаннем ODBC. Для PostgreSQL выкарыстайце лакальнае падключэнне да лакальнага сервера праз UNIX сокет і 127.0.0.1 для падлучэння праз TCP. Для SQLite задайце поўны шлях да файла базы дадзеных.',
...
$lang = array_merge($lang, array(
	'ALL_FILES_UP_TO_DATE'		=> 'Усе файлы адпавядаюць самой апошняй версіі phpBB. Зараз <a href="../ucp.php?mode=login">увайдзіце на канферэнцыю</a> і праверце, што ўсё працуе нармалёва. Не забудзьце выдаліць, пераназваць або перамясціць папку «install»! Калі ласка, адпраўце нам абноўленую інфармацыю аб вашым серверы і канфігурацыі канферэнцыі з дапамогай старонкі <a href="../ucp.php?mode=login&amp;redirect=adm/index.php%3Fi=send_statistics%26mode=send_statistics">Статыстычныя дадзеныя</a> у адміністратарскай частцы.',
	...
	'CONTINUE_UPDATE_NOW'			=> 'Працягвайце працэс абнаўлення',		// Shown within the database update script at the end if called from the updater
	...
	'UPDATE_INSTRUCTIONS'			=> '
		...
		<h1>Аб\'ява аб выхадзе новай версіі</h1>
...
$lang = array_merge($lang, array(
	...
	'MERGE_TOPIC_EXPLAIN'	=> 'Выкарыстаючы ніжэйпрыведзеную форму, вы можаце перанесці вылучаныя паведамленні ва ўжо наяўную тэму. Паведамленні будуць паказаныя ў тэме паводле часу іх дадання.<br />Увядзіце нумар адпаведнай тэмы або націсніце «Вылучыць тэму» для пошуку.',
...
$lang = array_merge($lang, array(
	...
	'EMAIL_DISABLED'		=> 'Выбачайце, але ўсе функцыі, звязаныя з адпраўкай email, былі адключаныя.',
	...
	'IM_NO_JABBER'			=> 'Выбачайце, адпраўка напроста паведамленняў карыстальнікам Jabber не падтрымліваецца серверам. Каб звязацца з гэтым карыстальнікам вам неабходны ўсталяваны кліент Jabber.',
...
$lang = array_merge($lang, array(
	...
	'UPLOAD_LINK'	=> 'Запампаваць',
	'FM_RADIO'		=> 'Popup FM Radio',
	'MP3_POPUP'		=> 'Popup Player',
	'NO_SEARCH'		=> 'Выбачайце, але вам забароненае карыстацца пошукам.',	
	'FORUM_RULES'	=> 'Правілы форума',
	'SHOUTBOX'		=> 'Shoutbox',

	'ST_NEW'				=> 'Today new',
	'ST_NEW_POSTS'			=> 'New Posts',
	'ST_NEW_TOPICS'			=> 'Новыя тэмы',
	'ST_NEW_ANNS'			=> 'Аб\'явы',
	'ST_NEW_STICKYS'		=> 'New Stickys',
	'ST_TOP'				=> 'Статыстыка',
	'ST_TOP_ANNS'			=> 'Аб\'явы',
	'ST_TOP_STICKYS'		=> 'New Stickys',
	'ST_TOT_ATTACH'			=> 'Укладанні',
	'ST_TOT_FILES'			=> 'File(s)',
...
$lang = array_merge($lang, array(
	...
	'FOUND_MORE_SEARCH_MATCHES'	=> 'Вынікаў пошуку больш за %d',
	...
	'LOGIN_EXPLAIN_NEWPOSTS'	=> 'Вы павінны быць зарэгістраваныя ў сістэме і аўтарызаваныя для прагляду новых паведамленняў з моманту вашага апошняга наведвання.',
...
$lang = array_merge($lang, array(
	...
	'CLICK_GOTO_FOLDER'			=> '%1$sПерайсці ў папку «%3$s»%2$s',
	...
	'CURRENT_PASSWORD_EXPLAIN'	=> 'Вы павінны паказаць дзеючы пароль, калі вы жадаеце змяніць імя карыстальніка або адрас email.',
	...
	'FIELD_INVALID_DATE'				=> 'Поле «%s» змяшчае недапушчальную дату.',
	'FIELD_INVALID_VALUE'				=> 'Поле «%s» змяшчае недапушчальнае значэнне.',
	...
	'NEW_EMAIL_CONFIRM_EMPTY'		=> 'Вы не ўвялі пацверджанне адрасу email.',
	'NEW_EMAIL_ERROR'				=> 'Уведзеныя вамі адрасы email не супадаюць.',
	'NEW_FOLDER_NAME'				=> 'Новае імя папкі',
	'NEW_PASSWORD'					=> 'Новы пароль',
	'NEW_PASSWORD_CONFIRM_EMPTY'	=> 'Вы не ўвялі пацверджанне пароля.',
	...
	'RULE_LIMIT_REACHED'				=> 'Немагчыма дадаць правіла, паколькі дасягнута максімальна магчымае колькасць правілаў.',
	...
	'SENT_AT'					=> 'Адпраўленае',			// Used before dates in private messages
	...
	'USERNAME_TAKEN_USERNAME'		=> 'Выбачайце, карыстальнік з такім імем ужо існуе',
...
$lang = array_merge($lang, array(
	...
	'NEW_POSTS_HOT'			=> 'Новыя паведамленні [ Папулярная тэма ]',	// Not used anymore
	'NEW_POSTS_LOCKED'		=> 'Новыя паведамленні [ Тэма зачыненая ]',	// Not used anymore
	'NO_NEW_POSTS_HOT'		=> 'Няма новых паведамленняў [ Папулярная тэма ]',	// Not used anymore
	'NO_NEW_POSTS_LOCKED'	=> 'Няма новых паведамленняў [ Тэма зачыненая ]',	// Not used anymore
...
$lang = array_merge($lang, array(
	...
	'ABBC3_HIGHSLIDE_PREVIOUSTEXT'		=> 'Назад',
	'ABBC3_HIGHSLIDE_PREVIOUSTITLE'		=> 'Previous (arrow left)',
	'ABBC3_HIGHSLIDE_NEXTTEXT'			=> 'Далей',
	'ABBC3_HIGHSLIDE_NEXTTITLE'			=> 'Next (arrow right)',
	'ABBC3_HIGHSLIDE_MOVETITLE'			=> 'Перамясціць',
	'ABBC3_HIGHSLIDE_MOVETEXT'			=> 'Перамясціць',
	...
	'BBCODE_STYLES_TIP'			=> 'Парада: можна хутка ўжыць стылі да вылучанага тэксту.',
	...
	'ABBC3_COLOR_MOVER'			=> 'Колер шрыфта',
...
$lang = array_merge($lang, array(
	...
	'ABBCODES_MAX_THUMB_WIDTH'			=> 'Максімальная шырыня мініяцюр',
...
$lang = array_merge($lang, array(
	...
	'ACP_F1_DRIVERS_EDIT_DRIVER'					=> 'Змяніць',
	...
	'ACP_F1_DRIVERS_DELETE_DRIVER'					=> 'Выдаліць',
	...
	'ACP_F1_TEAMS_EDIT_TEAM'						=> 'Змяніць',
	'ACP_F1_TEAMS_DELETE_TEAM'						=> 'Выдаліць',
...
$lang = array_merge($lang, array(
	...
	'CHALLENGE_PENDANT_FULL'			=> 'Выдаліць усё',
...
$lang = array_merge($lang, array(
	...
	'EDS_CAT_DESC'			=> 'Апісанне',
	'EDS_CAT_NAME'			=> 'Катэгорыя',
	'EDS_COST'				=> 'Costs',
...
$lang = array_merge($lang, array(
	...
	'FORMEL_CLOSE_WINDOW'			=> 'Зачыніць акно',
...
$lang = array_merge($lang, array(
	...
	'GALLERY_IMAGE'					=> 'Малюнак',
	'GALLERY_VIEWS'					=> 'Прагляды',
...
$lang = array_merge($lang, array(
	...
	'ALBUM_DESC'					=> 'Апісанне',
	'ALBUM_DESC_EXPLAIN'			=> 'Любая зададзеная тут разметка будзе адлюстраваная ў гэтым жа выглядзе.',
	...
	'DONT_COPY_PERMISSIONS'			=> 'Не капіяваць правы доступу',
	...
	'NO_INHERIT'					=> 'Не капіяваць правы доступу',
	'NO_PARENT_ALBUM'				=> 'Не',
	...
	'PERMISSION_NEVER'				=> 'Ніколі',
	'PERMISSION_NO'					=> 'Не',
	'PERMISSION_SETTING'			=> 'Налады',
	'PERMISSION_YES'				=> 'Так',
...
$lang = array_merge($lang, array(
	'CHOOSE_ACTION'					=> 'Вылучыць жаданае дзеянне',

	'GALLERY_MCP_MAIN'				=> 'Галоўная',
	'GALLERY_MCP_OVERVIEW'			=> 'Агляд',
	'GALLERY_MCP_QUEUE'				=> 'Queue',
	'GALLERY_MCP_QUEUE_DETAIL'		=> 'Image details',
	'GALLERY_MCP_REPORTED'			=> 'Reported images',
	'GALLERY_MCP_REPO_DONE'			=> 'Зачыненыя скаргі',
	'GALLERY_MCP_REPO_OPEN'			=> 'Адчыненыя скаргі',
	'GALLERY_MCP_REPO_DETAIL'		=> 'Інфармацыя аб скарзе',
	...
	'LATEST_IMAGES_REPORTED'		=> 'Апошнія 5 скарг',
	...
	'QUEUE_A_DELETE'				=> 'Выдаліць малюнак',
...
$lang = array_merge($lang, array(
	...
	'ACCESS_CONTROL_REGISTERED'		=> 'Зарэгістраваныя карыстальнікі',
...
$lang = array_merge($lang, array(
	...
	'HIGHSCORE_USER'				=> 'Імя карыстальніка',
	...
	'HIGHSCORE_ASC'					=> 'па ўзрастанні',
	'HIGHSCORE_DESC'				=> 'па змяншэнні',
...
Have fun!',
	...
	'ACP_SORT_ASC'						=> 'па ўзрастанні',
	'ACP_SORT_CAT'						=> 'Катэгорыя',
	'ACP_SORT_DESC'						=> 'па змяншэнні',
...
$lang = array_merge($lang, array(
	...
	'POINTS_GROUP_TRANSFER_ADD'			=> 'Дадаць',
	...
	'POINTS_GROUP_TRANSFER_VALUE'		=> 'Значэнне',
...
$lang = array_merge($lang, array(
	...
	'OPTION_USER'					=> 'Вылучыць карыстальніка',
	'OVERTIME'						=> 'Overtime',
	...
	'SHOW_PROFILE'					=> 'Паказаць профіль карыстальніка',
...
$lang = array_merge($lang, array(
	...
	'WHO_WAS_HERE_HIDDEN_USERS_TOTAL'		=> '%d утоены',
	'WHO_WAS_HERE_HIDDEN_USERS_ZERO_TOTAL'	=> '0 утоеных',
	'WHO_WAS_HERE_HIDDEN_USER_TOTAL'		=> '%d утоены',
	'WHO_WAS_HERE_BOTS_USERS_TOTAL'			=> '%d bots',
	'WHO_WAS_HERE_BOTS_USERS_ZERO_TOTAL'	=> '0 bots',
	'WHO_WAS_HERE_BOTS_USER_TOTAL'			=> '%d bot',
	'WHO_WAS_HERE_GUEST_USERS_TOTAL'		=> '%d госцяў',
	'WHO_WAS_HERE_GUEST_USERS_ZERO_TOTAL'	=> '0 госцяў',
	'WHO_WAS_HERE_GUEST_USER_TOTAL'			=> '%d госць',
	...
	'WHO_WAS_HERE_RECORD'			=> 'Больш за ўсё наведвальнікаў (<strong>%1$s</strong>) тут было %2$s',
...
$lang = array_merge($lang, array(
	...
	'LOGS_RECV'							=> 'Received',
	'LOGS_SENT'							=> 'Адпраўленае',
	'LOGS_SORT_COMMENT'					=> 'Comment',
	'LOGS_SORT_DATE'					=> 'Дата',
	'LOGS_SORT_FROMNAME'				=> 'Ад',
	...
	'POINTS_OPTIONS'					=> 'Налады',
	'POINTS_OVERVIEW'					=> 'Агляд',
...
$lang = array_merge($lang, array(
	...
	'SHOP_ITEM_DESCRIPTION'			=> 'Апісанне',
	'SHOP_ITEM_BUY'					=> 'Buy',
	...
	'SHOP_BACK_TO_PREV'				=> 'Вярнуцца на папярэднюю старонку',
	...
	'SHOP_CAT_NAME'					=> 'Катэгорыя',
	'SHOP_CAT_DESC'					=> 'Апісанне',
...
$lang = array_merge($lang, array(	
	...
	'USERS'								=> 'Карыстальнікі',
	'USERS_INACTIVE'					=> 'Неактыўныя карыстальнікі',
	...
	'STYLES'							=> 'Стылі',
	'IMAGESETS'							=> 'Наборы малюнкаў',
	'TEMPLATES'							=> 'Шаблоны',
	'THEMES'							=> 'Тэмы',
	'LANG_PACKS'						=> 'Моўныя пакеты',
	'BY'								=> 'By',
	...
	'WHO_IS_ONLINE_EXPLAIN'				=> 'заснавана на актыўнасці карыстальнікаў за апошнія %d хвілін',
	'RANKS_POSTS'						=> 'Ranks (Non-special ranks based on post count)',
	'RANKS'								=> 'Званні',
	'RANK_MIN_POSTS'					=> 'Minimum post count',
	'MEMBER_COUNT'						=> 'Member count',
	'DELETED_USERS'						=> 'Deleted users',
	'ATTACHMENTS_ORPHAN'				=> 'Страчаныя ўкладанні',
...
$lang = array_merge($lang, array(
	...
	'ATTACH_MAX_FILESIZE_EXPLAIN'		=> 'Максімальны памер кожнага загружанага файла. Калі значэнне роўна 0, памер файла абмежаваны толькі канфігурацыяй PHP.',
...
$lang = array_merge($lang, array(
	...
	'OPTIONS_BANNED'			=> 'Чорны спіс',
	'OPTIONS_EXCLUDED'			=> 'Белы спіс',
...
$lang = array_merge($lang, array(
	...
	'MAX_FILESIZE_EXPLAIN'			=> 'Максімальны памер файла для загружаных файлаў аватараў. Калі значэнне роўна 0, памер файла абмежаваны толькі канфігурацыяй PHP.',
...
$lang = array_merge($lang, array(
	...
	'NOTIFY'				=> 'Апавяшчэнне',
	'NO_ADMIN'				=> 'У вас няма правоў для адміністравання гэтага форума.',
...
$lang = array_merge($lang, array(
	...
	'INACTIVE_USERS_EXPLAIN_INDEX'	=> 'Ніжэй находзіцца спіс дзесяці апошніх зарэгістраваных карыстальнікаў, якія маюць неактыўныя ўліковыя запісы. Уліковыя запісы неактыўныя таму, што іх актывацыя прадугледжана наладамі канферэнцыі і запісы яшчэ не былі актываваныя, альбо таму, што запісы былі дэактываваныя. Поўны спіс неактыўных карыстальнікаў можна праглядзець, вылучыўшы адпаведную спасылку ў меню, або націснуўшы спасылку ніжэй «Неактыўныя карыстальнікі». На старонцы «Неактыўныя карыстальнікі» вы можаце актываваць, выдаліць або адправіць неактыўным карыстальнікам электроннае паведамленне з напамінкам аб актывацыі.',
	...
	'LOG_WARNINGS_DELETED'		=> '<strong>Выдаленае %2$s папярэджанняў у карыстальніка</strong><br />» %1$s',
...
$lang = array_merge($lang, array(
	...
	'UPLOAD_CENTER'		=> 'Запампаваць',
	'ACP_UP_IMAGESETS'		=> 'Upload Center',
	'UPLOAD_EDIT'			=> 'Запампаваць',
	...
	'ACP_PORTAL_CONFIG'		=> 'Portal Configuration',
	'ACP_BLOCKS'			=> 'Blocks',
	'ACP_BLOCKS_VARIABLES'	=> 'Асабістыя налады',
...
$lang = array_merge($lang, array(
	...
	'ACP_STATS_GENERAL_INFO'			=> 'Статыстыка',
...
$lang = array_merge($lang, array(
	'ACP_MANAGE_ATTACHMENTS'			=> 'Укладанні',
...
$lang = array_merge($lang, array(
	...
	'LOG_USER_REMINDER_INACTIVE'			=> '<strong>Адпраўленыя email-напамінкі неактыўным карыстальнікам</strong><br />» %s',
	...
	'ACP_SHOP_ITEM_DESCRIPTION'			=> 'Апісанне',
	...
	'ACP_SHOP_LOG_USER_ACT'				=> 'Лог карыстальнікаў',
	...
	'RT_POSTING'		=> 'Размяшчэнне паведамленняў',
	'RT_REPORT'			=> 'Reporting',
	...
	'ACP_GALLERY_ALBUM_PERMISSIONS'		=> 'Правы доступу',
	...
	'LOG_GALLERY_REPORT_CLOSED'			=> '<strong>Зачыненне скаргі</strong><br />» %s',
	'LOG_GALLERY_REPORT_DELETED'		=> '<strong>Выдаленне скаргі</strong><br />» %s',
	...
	'ACP_ARCADE_PERMISSION_TRACE'						=> 'Трасіроўка праў доступу',
	...
	'ROLE_ARCADE_FULL'					=> 'Поўны доступ',
	'ROLE_ARCADE_LIMITED'				=> 'Абмежаваны доступ',
	'ROLE_ARCADE_NOACCESS'				=> 'Няма доступу',
	'ROLE_ARCADE_PLAYONLY'				=> 'Play Only Access',
	'ROLE_ARCADE_STANDARD'				=> 'Стандартны доступ',
	...
	'ACP_CAT_ARCADE_PERMISSION_MASKS'	=> 'Маскі праў доступу',
	...
	'CAT_LINK_TRACK'					=> 'Адсочваць пераходы',
	...
	'CAT_PASSWORD_MISMATCH'				=> 'Уведзеныя паролі не супадаюць.',
	...
	'ARCADE_DELETE_MARKED'			=> 'Выдаліць адзначаныя',
	...
	'ARCADE_LIMIT_PLAY_BOTH'				=> 'Абодва спосабу',
	...
	'ARCADE_CAT_DISPLAY_IMAGE'				=> 'Малюнак',
	'ARCADE_NEWEST_GAMES'					=> 'Newest games',
	...
	'ARCADE_CHECK_UPDATES'						=> 'Праверка абнаўленняў',
...
$lang = array_merge($lang, array(
	...
	'ARCADE_GAME_FILESIZE'					=> 'Памер файла', 
	...
	'IPSEARCH_ACCOUNT_LONG'			=>	'Рэгістрацыя',
	'IPSEARCH_IP'					=>	'IP',
	'IPSEARCH_LOGS'					=>	'Logs',
	'IPSEARCH_USERS'				=>	'Карыстальнікі',
...
$lang = array_merge($lang, array(
	...
	'RESTORE_SELECTED_BACKUP'	=> 'Вы ўпэўнены, што жадаеце аднавіць дадзеныя з абранай рэзервовай копіі?',
...
$lang = array_merge($lang, array(
	...
	'MAIL_BANNED'			=> 'Адправіць заблакаваным карыстальнікам',
	'MAIL_BANNED_EXPLAIN'	=> 'Пры масавым рассыланні групе дадзеная настройка вызначае, ці будуць email-паведамленні адпраўленыя заблакаваным карыстальнікам.',
...
$lang = array_merge($lang, array(
	...
	'GROUP_ADD_USERS'				=> 'Даданне карыстальнікаў',
	'ADD_USERS_EXPLAIN'				=> 'Тут вы можаце дадаваць новых карыстальнікаў у групу. Вы можаце вылучыць, ці стане гэтая група групай па змаўчанні для вылучаных карыстальнікаў. Таксама тутака ж можна прызначаць лідэраў групы. Уводзіце імя кожнага карыстальніка на новым радку.',
...
$lang = array_merge($lang, array(
	...
	'LANGUAGE_PACK_CPF_UPDATE'			=> 'Моўныя радкі дадатковых палёў профілю былі скапіяваныя з моўнага пакета па змаўчанні. Зменіце іх, калі гэта неабходна.',
...
$lang = array_merge($lang, array(
	...
	'COPY_PERMISSIONS_FORUM_TO_EXPLAIN'		=> 'Канцавыя форумы, да якіх вы жадаеце ўжыць скапіяваны правы доступу.',
	'COPY_PERMISSIONS_FROM'					=> 'Капіраваць права з форуму',
	'COPY_PERMISSIONS_TO'					=> 'Ужыць права на форумах',
	...
	'ROLE_FORUM_NEW_MEMBER'		=> 'Доступ Новых карыстальнікаў',
	...
	'ROLE_USER_NEW_MEMBER'		=> 'Магчымасці Новых карыстальнікаў',
	...
	'SET_USERS_PERMISSIONS'			=> 'Усталяваць правы карыстальніка',
	'SET_USERS_FORUM_PERMISSIONS'	=> 'Усталяваць форумныя правы карыстальніка',
...
$lang = array_merge($lang, array(
	...
	'SEO_CACHE_FORUM_NAME'	=> 'Назоў форума',
	...
	'ACP_ZERO_DUPE_OFF'	=> 'Адключана',
	'ACP_ZERO_DUPE_MSG'	=> 'Паведамленне',
	'ACP_ZERO_DUPE_GUEST'	=> 'Госць',
	'ACP_ZERO_DUPE_ALL'	=> 'Усе',
...
$lang = array_merge($lang, array(
	...
	'BBCODE_DANGER_PROCEED'		=> 'Працягнуць', //'I understand the risk',
	...
	'SMILIE_NO_EMOTION'			=> 'Смайлік «%s» не быў дададзены, так як для яго не зададзена эмоцыя.',
	'SMILIE_NO_FILE'			=> 'Смайлік «%s» не быў дададзены, так як для яго адсутнічае файл.',
...
$lang = array_merge($lang, array(
	'ACP_DISALLOW_EXPLAIN'	=> 'Тут вы можаце кіраваць імёнамі карыстальнікаў, забароненымі для выкарыстання. Забароненыя імёны могуць утрымоўваць падстаноўныя знакі (*).',
	...
	'DISALLOWED_ALREADY'		=> 'Уведзенае імя ўжо забароненае.',
...
$lang = array_merge($lang, array(
	...
	'SHOW_NOVALUE_FIELD'			=> 'Адлюстроўваць поле без значэння',
	'SHOW_NOVALUE_FIELD_EXPLAIN'	=> 'Усталёўвае, ці будзе адлюстравана поле профілю ў выпадку, калі абраны варыянт без значэння для неабавязковага поля, альбо не было абрана значэнне для абавязковага поля.',
...
$lang = array_merge($lang, array(
	...
	'DELETE_STYLE_EXPLAIN'		=> 'Тут вы можаце выдаліць вылучаны стыль. Будзьце асцярожныя, выдаленне нельга будзе адмяніць.',
	...
	'EDIT_THEME_EXPLAIN'				=> 'Тут вы можаце рэдагаваць вылучаную тэму, змяняць колеры, малюнкі і г.д.',
	...
	'KEEP_IMAGESET'				=> 'Не выдаляць набор малюнкаў «%s»',
	'KEEP_TEMPLATE'				=> 'Не выдаляць шаблон «%s»',
	'KEEP_THEME'				=> 'Не выдаляць тэму «%s»',
	...
	'REPLACE_WITH_OPTION'		=> 'Замяніць на «%s»',
...
$lang = array_merge($lang, array(
	...
	'DELETE_POSTS'			=> 'Выдаліць паведамленні',
	'DELETE_USER'			=> 'Выдаліць карыстальніка',
	'DELETE_USER_EXPLAIN'	=> 'Улічыце, што выдаленне карыстальніка незваротна, ён не можа быць адноўлены. Непрачытаныя асабістыя паведамленні, адпраўленыя дадзеным карыстальнікам, таксама будуць выдаленыя і не будуць даступныя атрымальнікам.',
	...
	'USER_NO_POSTS_TO_DELETE'			=> 'Адсутнічаюць паведамленні, якія належаць карыстальніку.',
