...
$lang = array_merge($lang, array(
	...
	'FIELD_INVALID_CHARS_ALPHA_SPACERS'	=> '欄位「%s」包含無效字元，只允許填入英文字母與數字、空格和 -+_[] 這些特殊字元。',
