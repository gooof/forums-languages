...
$lang = array_merge($lang, array(
	...
	'YMSM_MAP_CENTER_EXPLAIN' 		=> 'Default map center position (lattiude,longitude).',	
...
$lang = array_merge($lang, array(
	'YMSM_VERSION'							=> 'เวอร์ชั่น',
	'YMSM_FILE_VERSION'						=> 'Files Version',
	'YMSM_LATEST_VERSION'					=> 'Latest Version',
	'YMSM_DATABASE_VERSION'					=> 'Database Version',
	'YMSM_CLICK_CHECK_NEW_VERSION'			=> 'Click %shere%s to check for an updated version of the phpBB geo topics mod',
	'YMSM_CLICK_GET_NEW_VERSION'			=> 'Click %shere%s to get the latest version of the phpBB geo topics mod',
	'YMSM_CLICK_UPDATE'						=> 'Click %shere%s to update the database for the phpBB geo topics mod',
	'YMSM_ENABLE_INTEGRATION'				=> 'Enable integration',
	'YMSM_ENABLE_INTEGRATION_EXPLAIN'		=> 'Enables phpBB geo topics mod functionality except the mod front page. All the integration functions will be enabled/disabled.',
	...
	'YMSM_JQUERY_PATH'						=> 'JQuery location',
	'YMSM_JQUERY_PATH_EXPLAIN' 				=> 'Location utl to load JQuery. Specify an url from CDN or from your own site. Minimum required version is 1.6.4.',
	'YMSM_JQUERY_LOAD'						=> 'JQuery load',
	'YMSM_JQUERY_LOAD_EXPLAIN' 				=> 'Set "Disabled" if JQuery is loaded by some other component (mod) over the all site pages.',
	...
	'YMSM_ICON_PATH'						=> 'POI icon storage path',
	'YMSM_ICON_PATH_EXPLAIN'				=> 'Path under your phpBB root directory, e.g. <i>images/ymsm_icons</i>.',
	...
	'YMSM_EAPI_OSM'							=> 'OSM Maps',
	'YMSM_EAPI_OSM_EXPLAIN'					=> 'Show link to OSM Maps. This setting is ignored if OSM Maps is default provider.',
	'TAG_USER_TH'							=> 'User maps',
	'TAG_USER'								=> 'Show tag at user maps only',
	'YMSM_EAPI_GEOIPCITY'					=> 'Geo IP City database',
	'YMSM_EAPI_GEOIPCITY_EXPLAIN'			=> 'Automatically get the user location from the registration IP. Leave if OFF if your did not updoad database files to your host. See readme.txt at contrib/ipdatabase.',
