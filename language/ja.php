...
$lang = array_merge($lang, array(
	...
	'LOG_POST_EDITED_AJAX_TITLE'	=> '<strong>New Topic Title for „%1$s“</strong>',
...
',
	...
	'POST_GLOBAL'				=> 'グローバル告知トピック',
	'POST_ICON'					=> '記事アイコン',
	'POST_NORMAL'				=> '普通',
	'POST_REVIEW'				=> '編集記事のレビュー',
...
$lang = array_merge($lang, array(
	...
	'FIELD_INVALID_CHARS_ALPHA_SPACERS'	=> 'フィールド “%s” の値は無効です。アルファベット・数字・スペースと符号 -+_[] のみ使用可能です。',
	...
	'NOTIFICATION_METHOD_EMAIL'							=> 'メールアドレス',
...
$lang = array_merge($lang, array(
	...
	'ACP_LOTTERY_MAX_TICKETS'				=> 'Max. number of tickets',
	...
	'ACP_LOTTERY_NEXT_DRAWING'				=> 'Next Draw',
	...
	'ACP_ROBBERY_CHANCE'					=> 'Chance to make a successful robbery',
	...
	'ACP_ROBBERY_MAX_ROB'					=> 'Percantage of maximum robbery',
...
$lang = array_merge($lang, array(
	...
	'LOG_RESET_CPF_REMINDER'		=> '<strong>Reset custom profile fields update reminder</strong>',
	'LOG_POST_EDITED_AJAX_TITLE'	=> '<strong>New Topic Title for „%1$s“</strong>',
	'ACP_CHECKREPAIR'		=> 'Datenbank Repair',
	'ACP_FIND'				=> 'RSS/XML Feed Import',
	'ACP_CALENDAR_EVENTS'	=> 'Calendar Dates Manager',
	'OR'					=> '&#x25B2; or &#x25BC;',
	'TRANSPARENT'			=> 'transparent',
	'IGNORE_SINCE_LIMIT'	=> 'Ignore the character limit for this change',
	'ONLY_PREMIUM'			=> ' <code><a href="http://www.forums3.com/management/index.php?page=premium" target="_blank">Premium Feature</a></code>',
	'PREMIUM_NOT_ACTIVE'	=> 'This feature is only available with an active Premium Package.',
	'ACTIVATE_IN_CONFIG'	=> 'This feature must first be enabled in the <strong>%s</strong>.',
	'ACP_WELCOME_TOPIC'		=> 'Welcome Topic activate',
	'ACP_WELCOME_TOPIC_EXPLAIN'		=> 'When enabled, all users will be forced to read a given topic before they can move in the forum or read other topics.',
	'ACP_WELCOME_TOPIC_ID'			=> 'Welcome Topic ID',
	'ACP_WELCOME_TOPIC_ID_EXPLAIN'		=> 'Enter the ID of the topic you wish to redirect all users after the login. If you change the topic ID here, all users need to read the new welcome topic.',
	'CPF_UPDATE_REMINDER'				=> 'Enable custom profile fields update reminder',
	'CPF_UPDATE_REMINDER_EXPLAIN'		=> 'Reminds users to force update any custom profile field, that is unset, active, required, and displayed on user control panel.',
	'POSTING_WIDTH'			=> 'Maximum Number of characters for Post/Thread titles',
	'POSTING_WIDTH_EXPLAIN'	=> 'The default is 60 characters. Increase the number of characters with caution as not all support Title Styles in excess length.',
	'ACP_UP_APPLEICON'		=> 'Apple Touch Icon',
	'SCHON_VORHANDEN'		=> 'There already exists a preceding specified BBCode with this name, you can not changed this.',
	'MAIN_LOG'				=> 'ACP-/MCP Logs',
	'BBCODE_ICON'			=> 'Editor Icon',
	'BBCODE_ICON_EXPLAIN'	=> 'Choose here a icon for the bbcode in editor, if you want to use one. If no icon is selected, a button with the BBCode tag appears.',
	'BBCODE_ICON_TEXT'		=> 'Icon:',
...
$lang = array_merge($lang, array(
	...
	'EXTENSION_DISABLE'		=> '無効にする',
	'EXTENSION_ENABLE'		=> '有効にする',
...
$lang = array_merge($lang, array(
	...
	'AUTO_PRUNE_SHADOW_FREQ_EXPLAIN'	=> 'この日数が経つ毎にトピックのプルーニング（一括削除）が実行されます',
