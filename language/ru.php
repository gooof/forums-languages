...
$lang = array_merge($lang, array(
	...
	'EVENT_ACCESS_LEVEL_GROUP'		=> 'Группа',
	...
	'NO_POST_EVENT_MODE'		=> 'Не указан режим сообщения.',
	'PM'						=> 'Личное сообщение',
...
$lang = array_merge($lang, array(
	...
	'ST_NEW_TOPICS'			=> 'Новые темы',
	'ST_NEW_ANNS'			=> 'Объявления',
	'ST_NEW_STICKYS'		=> 'New Stickys',
	'ST_TOP'				=> 'Статистика',
	'ST_TOP_ANNS'			=> 'Объявления',
	'ST_TOP_STICKYS'		=> 'New Stickys',
	'ST_TOT_ATTACH'			=> 'Вложения',
	'ST_TOT_FILES'			=> 'File(s)',
...
$lang = array_merge($lang, array(
	...
	'NEW_POSTS_HOT'			=> 'Новые сообщения [ Популярная тема ]',	// Not used anymore
	'NEW_POSTS_LOCKED'		=> 'Новые сообщения [ Тема закрыта ]',	// Not used anymore
	'NO_NEW_POSTS_HOT'		=> 'Нет новых сообщений [ Популярная тема ]',	// Not used anymore
	'NO_NEW_POSTS_LOCKED'	=> 'Нет новых сообщений [ Тема закрыта ]',	// Not used anymore
...
$lang = array_merge($lang, array(
	...
	'ABBC3_HIGHSLIDE_NEXTTEXT'			=> 'Далее',
	'ABBC3_HIGHSLIDE_NEXTTITLE'			=> 'Next (arrow right)',
	'ABBC3_HIGHSLIDE_MOVETITLE'			=> 'Переместить',
	'ABBC3_HIGHSLIDE_MOVETEXT'			=> 'Переместить',
	...
	'BBCODE_STYLES_TIP'			=> 'Совет: можно быстро применить стили к выделенному тексту.',
	...
	'ABBC3_RAM_TAG'				=> 'Файлы Real Media',
...
$lang = array_merge($lang, array(
	...
	'ABBCODES_MAX_THUMB_WIDTH'			=> 'Максимальная ширина миниатюр',
...
$lang = array_merge($lang, array(
	...
	'ACP_F1_SETTINGS_FORUM'							=> 'Главная страница',
	...
	'ACP_F1_DRIVERS_EDIT_DRIVER'					=> 'Изменить',
	...
	'ACP_F1_DRIVERS_DELETE_DRIVER'					=> 'Удалить',
	...
	'ACP_F1_TEAMS_EDIT_TEAM'						=> 'Изменить',
	'ACP_F1_TEAMS_DELETE_TEAM'						=> 'Удалить',
...
$lang = array_merge($lang, array(
	...
	'ARCADE_GAMES_SORT_NAME'			=> 'Название',
	...
	'ARCADE_DOWNLOAD'					=> 'Скачать',
	'ARCADE_VIEW'						=> 'View',
	'ARCADE_CREATE'						=> 'Create',
	'ARCADE_DOWNLOAD_GAME'				=> 'Download game',
	'ARCADE_DOWNLOAD_AS'				=> 'Скачать в формате',
...
$lang = array_merge($lang, array(
	...
	'CHALLENGE_PENDANT_FULL'			=> 'Удалить все',
	...
	'CHALLENGE_NO_CHAMP'				=> '<center><b>В настоящее время есть не проблем аркада</b></center>',
...
$lang = array_merge($lang, array(
	...
	'EDS_DOWNLOAD'			=> 'Скачать',
	'EDS_DOWNLOADS'			=> 'Скачивания',
...
$lang = array_merge($lang, array(
	...
	'FORMEL_NEXT_RACE'				=> 'Далее',
	'FORMEL_PREV_RACE'				=> 'Назад',
	'FORMEL_PLACE'					=> 'Place',
	'FORMEL_EDIT'					=> 'Изменить',
	'FORMEL_RULES'					=> 'Rules',
	...
	'FORMEL_CLOSE_WINDOW'			=> 'Закрыть окно',
...
$lang = array_merge($lang, array(
	'CHOOSE_ACTION'					=> 'Выбрать желаемое действие',

	'GALLERY_MCP_MAIN'				=> 'Главная',
	'GALLERY_MCP_OVERVIEW'			=> 'Введение',
	...
	'GALLERY_MCP_REPO_DETAIL'		=> 'Информация о жалобе',
	...
	'REPORTS_A_OPEN'				=> 'Открытые жалобы',
...
$lang = array_merge($lang, array(
	...
	'HIGHSCORE_USER'				=> 'Имя пользователя',
	...
	'HIGHSCORE_ASC'					=> 'по возрастанию',
	'HIGHSCORE_DESC'				=> 'по убыванию',
...
Have fun!',
	...
	'ACP_SORT_ASC'						=> 'по возрастанию',
	'ACP_SORT_CAT'						=> 'Категория',
	'ACP_SORT_DESC'						=> 'по убыванию',
...
$lang = array_merge($lang, array(
	...
	'POINTS_GROUP_TRANSFER_ADD'			=> 'Добавить',
	...
	'POINTS_GROUP_TRANSFER_VALUE'		=> 'Значение',
...
$lang = array_merge($lang, array(
	...
	'OPTION_USER'					=> 'Выбрать пользователя',
	'OVERTIME'						=> 'Overtime',
	...
	'PRINT'							=> 'Print',
	'PRINT_ALL'						=> 'Print All',
	'PRINT_FOOTBALL'				=> 'Версия для печати',
...
$lang = array_merge($lang, array(
	...
	'WHO_WAS_HERE_HIDDEN_USERS_TOTAL'		=> 'скрытых: %d',
	'WHO_WAS_HERE_HIDDEN_USERS_ZERO_TOTAL'	=> 'скрытых: 0',
	'WHO_WAS_HERE_HIDDEN_USER_TOTAL'		=> 'скрытых: %d',
	'WHO_WAS_HERE_BOTS_USERS_TOTAL'			=> '%d bots',
	'WHO_WAS_HERE_BOTS_USERS_ZERO_TOTAL'	=> '0 bots',
	'WHO_WAS_HERE_BOTS_USER_TOTAL'			=> '%d bot',
	'WHO_WAS_HERE_GUEST_USERS_TOTAL'		=> 'гостей: %d',
	'WHO_WAS_HERE_GUEST_USERS_ZERO_TOTAL'	=> 'гостей: 0',
	'WHO_WAS_HERE_GUEST_USER_TOTAL'			=> 'гостей: %d',
...
$lang = array_merge($lang, array(
	...
	'SHOP_BACK_TO_PREV'				=> 'Вернуться на предыдущую страницу',
...
$lang = array_merge($lang, array(	
	...
	'USERS'								=> 'Пользователи',
	'USERS_INACTIVE'					=> 'Неактивированные пользователи',
	...
	'ATTACHMENTS_ORPHAN'				=> 'Потерянные вложения',
...
$lang = array_merge($lang, array(
	...
	'UPLOAD_CENTER'		=> 'Закачать',
	'ACP_UP_IMAGESETS'		=> 'Upload Center',
	'UPLOAD_EDIT'			=> 'Закачать',
	...
	'ACP_PORTAL_CONFIG'		=> 'Portal Configuration',
	'ACP_BLOCKS'			=> 'Blocks',
	'ACP_BLOCKS_VARIABLES'	=> 'Личные настройки',
...
$lang = array_merge($lang, array(
	...
	'LOG_USER_REMINDER_INACTIVE'			=> '<strong>Отправлены email-напоминания неактивированным пользователям</strong><br />» %s',
	...
	'ACP_SHOP_LOG_USER_ACT'				=> 'Лог пользователей',
	...
	'RT_VIEWFORUM'		=> 'Главная страница',
	'RT_VIEWTOPIC'		=> 'Viewtopic',
	'RT_VIEWONLINE'		=> 'Viewonline',
	'RT_POSTING'		=> 'Размещение сообщений',
	'RT_REPORT'			=> 'Reporting',
	...
	'LOG_GALLERY_REPORT_CLOSED'			=> '<strong>Закрытие жалобы</strong><br />» %s',
	'LOG_GALLERY_REPORT_DELETED'		=> '<strong>Удаление жалобы</strong><br />» %s',
	...
	'ACP_ARCADE_PERMISSION_TRACE'						=> 'Трассировка прав доступа',
	...
	'ROLE_ARCADE_FULL'					=> 'Полный доступ',
	'ROLE_ARCADE_LIMITED'				=> 'Ограниченный доступ',
	'ROLE_ARCADE_NOACCESS'				=> 'Нет доступа',
	'ROLE_ARCADE_PLAYONLY'				=> 'Play Only Access',
	'ROLE_ARCADE_STANDARD'				=> 'Стандартный доступ',
	...
	'ACP_CAT_ARCADE_PERMISSION_MASKS'	=> 'Маски прав доступа',
	...
	'CAT_LINK_TRACK'					=> 'Отслеживать переходы',
	...
	'CAT_PASSWORD_MISMATCH'				=> 'Введённые пароли не совпадают.',
	...
	'ARCADE_DELETE_MARKED'			=> 'Удалить отмеченные',
	...
	'ARCADE_LIMIT_PLAY_BOTH'				=> 'Оба способа',
	...
	'ARCADE_CAT_DISPLAY_NAME'				=> 'Название',
	...
	'ARCADE_CHECK_UPDATES'						=> 'Проверка обновлений',
...
$lang = array_merge($lang, array(
	...
	'ARCADE_GAME_FILESIZE'					=> 'Размер файла', 
...
$lang = array_merge($lang, array(
	...
	'SEO_INSTALL_CONGRATS'			=> 'Поздравляем!',
	...
	'SEO_CACHE_FORUM_NAME'	=> 'Название форума',
	...
	'ACP_ZERO_DUPE_OFF'	=> 'Отключено',
	'ACP_ZERO_DUPE_MSG'	=> 'Сообщение',
	'ACP_ZERO_DUPE_GUEST'	=> 'Гость',
	'ACP_ZERO_DUPE_ALL'	=> 'Все',
...
$lang = array_merge($lang, array(
	...
	'BBCODE_DANGER_PROCEED'		=> 'Продолжить', //'I understand the risk',
