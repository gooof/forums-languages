...
Su solicitud para ingresar en el grupo "{GROUP_NAME}" en "{SITENAME}" ha sido aprobada.
Haga clic en el siguiente enlace para ver su membresía.
...
Está recibiendo esta notificación porque sigue el foro, "{FORUM_NAME}" de "{SITENAME}".
Este tema ha recibido una respuesta desde su última visita. 
Siguiendo este enlace puede ver esa respuesta, no se enviarán más notificaciones hasta que visite ese tema.

Si quiere ver los nuevos mensajes desde su última visita, haga clic en el siguiente enlace:
{U_NEWEST_POST}
...
Si no quiere seguir más ese tema puede hacer clic en "Cancelar suscripción al tema" cuando esté allí, 
o bien siguiendo este enlace:
